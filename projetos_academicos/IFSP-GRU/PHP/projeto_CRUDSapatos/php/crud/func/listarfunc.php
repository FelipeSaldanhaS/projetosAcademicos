...
?>
    ...
    <head>
        <title>Lista funcionários da Sapataria</title>
        <meta charset="UTF-8" />
    ...
    <body>
        ...
        <div class="container">
            ...
            <?php
            $consulta = "select * from tbfunc;";
            $executar = mysqli_query($conn, $consulta);
            while ($linha = mysqli_fetch_array($executar)) {
            ?>
                <div id="cx1">
                    Código: <input type="text" value="<?php echo $linha['codfunc']; ?>" readonly /><br>
                    Nome: <input type="text" value="<?php echo $linha['nome_funcionario']; ?>" readonly /><br>
